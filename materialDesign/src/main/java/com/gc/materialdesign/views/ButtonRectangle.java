...
//		centrarTexto();
		super.onDraw(canvas);
		if (x != -1) {
			Rect src = new Rect(0, 0, getWidth()-Utils.dpToPx(8, getResources()), getHeight()-Utils.dpToPx(8, getResources()));
			Rect dst = new Rect(Utils.dpToPx(8, getResources()), Utils.dpToPx(8, getResources()), getWidth()-Utils.dpToPx(8, getResources()), getHeight()-Utils.dpToPx(8, getResources()));
